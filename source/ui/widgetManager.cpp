		...
		while (!nodesToCheck.empty())
			{
				...
				glm::vec2 position = transform * glm::vec4(top.widget->transform.getPosition(m_windowSize), 0.f, 1.f);
				glm::vec2 size = transform * glm::vec4(top.widget->transform.getSize(m_windowSize), 0.f, 1.f);
...
widgetManager::widgetManager(glm::vec2 windowSize) :
	...
	m_windowSize(windowSize)
	{
		...
		a.widget.transform.setPosition({ 50.f, 50.f }, widgetTransform::type::ABSOLUTE);
